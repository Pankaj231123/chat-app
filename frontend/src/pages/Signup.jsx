...
const highlights = [
  {
    ...
    description: 'Pick a username, join rooms quickly, and keep one account across all conversations.',
  },
  {
    title: 'Secure by default',
    description: 'Protected rooms, JWT auth, and encrypted message storage keep the experience private.',
  },
  {
    title: 'Recover access fast',
    description: 'Password reset links help you get back into your account without losing your history.',
  },
]
      ...
      >
        ...
        >
          ...
          >
            <div style={styles.authInner}>
              <h2 style={{ ...styles.title, ...(isMobile ? styles.titleMobile : null) }}>Create account</h2>
        ...
        >
          <div style={{ ...styles.infoInner, ...(isMobile ? styles.infoInnerMobile : null) }}>
            ...
            >
              Build your account and enter the conversation.
            </h1>
            <p style={{ ...styles.heroText, ...(isMobile ? styles.heroTextMobile : null) }}>
              Create your profile once, unlock live chat rooms, and keep your message history connected to you.
            </p>
